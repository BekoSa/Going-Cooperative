...
Require-Text $buildingCaptureSource 'ReplicationClientBuildCommandChunkPlacements = 4' "bounded client build command chunk"
Require-Text $buildingCaptureSource 'ReplicationHostBuildReplayChunkPlacements = 4' "bounded host build replay chunk"
Require-Text $buildingCaptureSource 'ReplicationPendingHostBuildReplayChunks' "pre-reliable host build replay queue"
Require-Text $buildingCaptureSource 'if \(durablePending > 0\)' "ACK-paced host build replay admission"
