    ...
    public sealed partial class GoingCooperativePlugin
    {
        ...
        private void LogReplicationDirectTransportPerfIfDue()
        {
            ...
            LogReplicationInfo("[MP/NET] direct perf"
                ...
                + " pendingRx=" + replicationTransport.PendingMessages.ToString(CultureInfo.InvariantCulture)
                + " pendingTx=" + replicationTransport.PendingOutgoingMessages.ToString(CultureInfo.InvariantCulture)
